                ...
                <div class="head">
                    <form action="#" method="post">
                        <div class="header-img">
                            ...
                            <%}%>
                            <input name="concern" value="<%=weibo.getUserId()%>" style="display: none">
                            <button onclick="this.form.action='otherUserPage'; this.form.submit();" style="background-color:transparent; border: none">
                                <img src="<%=weibo.getUserImage()%>" class="head-img"
                                >
                            </button>
                            <span
