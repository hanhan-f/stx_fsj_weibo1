            ...
            <div class="top-nav-login">
                ...
                <div class="login-center">
                    <ul class="login-item">
                        ...
                        <li class="top-navi-tem"><a href="javascript:;"><img src="images/message.png" alt="消息"></a></li>
                        <li class="top-navi-tem"><a href="userMessage" target="Right-main"><img src="images/personal.png" alt="个人主页"></a></li>
                    </ul>
                </div>
            ...
            <div class="total-box-down">
                <div class="down-LeftPane">
                    <div class="LeftPane-side side">
                        <ul>
                            <li class="list-item"><a href="myWeibo" target="Right-main">我的主页</a></li>
                            <li class="list-item"><a href="MyConcerns" target="Right-main">我的关注</a></li>
                            <li class="list-item"><a href="javascript:;" target="Right-main">我的粉丝</a></li>
                            <li class="list-item"><a href="javascript:;" target="Right-main">我的收藏</a></li>
                            <li class="list-item"><a href="javascript:;" target="Right-main">浏览记录</a></li>
                            <li class="list-item"><a href="userMessage" target="Right-main">修改资料</a></li>
                        </ul>
                    </div>
                </div>
                <div class="down-RightPane">
                    <div class="RightPane-main">
                        <iframe name="Right-main" class="frame" src="myWeibo"></iframe>
                    </div>
